package br.com.redhat.microprofile.metrics;
...
@Path("/")
@ApplicationScoped
public class PrimeNumberCheckerResource {

    private static Logger logger = Logger.getLogger(PrimeNumberCheckerResource.class.getName());
